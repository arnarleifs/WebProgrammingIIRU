...
```tsx
"flex justify-center items-center py-12" // Spinner container CSS
"w-8 h-8 border-4 border-gray-200 border-t-black rounded-full animate-spin" // Spinner animation and look
```
